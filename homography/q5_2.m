...
scaleFactorX=1280/3000;%3000=size(panoImg_q51,2)
scaleFactorY=(1280/3.25)/1068;%1068=size(panoImg_q51,1)
...
taj2_im1 = warpH(im1,M,[1280/2,1280],0);

taj2_warped = warpH(im2,M*H2to1_q52,[1280/2,1280],0);
