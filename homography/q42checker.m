function q43checker
  ...
  [img_yourname_warped, img_PNCpark_yourname]=warp2PNCpark(img_PNCpark, img_yourname, A.p1(1:4,:), A.p2(1:4,:));
%[img_yourname_warped]=warp2PNCpark(img_PNCpark,img_yourname,A.p1, A.p2);
